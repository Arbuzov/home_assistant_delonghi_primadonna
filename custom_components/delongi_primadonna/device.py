...
class DelongiPrimadonna:
    ...
    def cup_light_on(self) -> None:
        ...
        try:
            ...
            device = self.adapter.connect(self.mac, timeout=20)
            device.char_write(CHARACTERISTIC,
                              bytearray([0x0d, 0x0b, 0x90, 0x0f, 0x00, 0x3f, 0x00, 0x00, 0x00, 0x99, 0x39, 0x22]))
    ...
    def cup_light_off(self) -> None:
        ...
        try:
            ...
            device = self.adapter.connect(self.mac, timeout=20)
            device.char_write(CHARACTERISTIC,
                              bytearray([0x0d, 0x0b, 0x90, 0x0f, 0x00, 0x3f, 0x00, 0x00, 0x00, 0x91, 0xb8, 0x2a]))
    ...
    def coffe_long_start(self) -> None:
        ...
        try:
            ...
            device = self.adapter.connect(self.mac, timeout=20)
            device.char_write(CHARACTERISTIC,
                              bytearray([0x0d, 0x0f, 0x83, 0xf0, 0x03, 0x01, 0x01, 0x00, 0xa0, 0x02, 0x03, 0x00, 0x00, 0x06, 0x18, 0x7f]))
    ...
    def coffe_long_cancel(self) -> None:
        ...
        try:
            ...
            device = self.adapter.connect(self.mac, timeout=20)
            device.char_write(CHARACTERISTIC,
                              bytearray([0x0d, 0x08, 0x83, 0xf0, 0x03, 0x02, 0x06, 0xf3, 0x81]))
